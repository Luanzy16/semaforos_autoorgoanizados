...
from interseccion_convencional import InterseccionConvencional

class SimulacionConvencional:
    def __init__(self, master):
        self.master = master
        master.title("Simulador de Semaforos Convencionales")
        ...
        self.intersecciones = [
            InterseccionConvencional("A", self.posiciones["A"]),
            InterseccionConvencional("B", self.posiciones["B"]),
            InterseccionConvencional("C", self.posiciones["C"]),
            InterseccionConvencional("D", self.posiciones["D"])
        ]
