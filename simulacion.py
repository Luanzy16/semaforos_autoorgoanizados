from interseccion import Interseccion #Importa la clase Interseccion desde otro módulo
import random #Importa módulo para generar números aleatorios

class Simulacion:
    #Gestiona la simulación de tráfico con múltiples intersecciones
    def __init__(self):
        ...
        self.tiempo = 0 #Contador de pasos de simulación (tiempo discreto)
    ...
    def paso(self):
        ...
        self.tiempo += 1  #Incrementa el contador de tiempo de simulación